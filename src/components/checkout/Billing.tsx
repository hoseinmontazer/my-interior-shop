...
const Billing = () => {
  return (
    <section className="container mx-auto py-10 xl:py-32 flex flex-col xl:flex-row">
      <form className="w-full xl:w-1/2 p-8 flex flex-col">
        <h1 className="font-bold m-3 pb-5 text-5xl">Billing details</h1>
        <section className="flex flex-col xl:flex-row">
          <div className="w-full lg:w-1/2">
            <label className="text-lg font-semibold py-2 m-3">First Name</label>
            <input
          ...
          <div className="w-full lg:w-1/2">
            <label className="text-lg font-semibold py-2 m-3">Last Name</label>
            <input
              className="border-2 border-stone-400 rounded-xl py-7 m-3"
              type="text"
            />
        ...
        <label className="text-lg font-semibold py-2 m-3">Street address</label>
        <input
          className="border-2 border-stone-400 rounded-xl w-10/12 py-7 mt-1 m-3"
          type="text"
        />
        <label className="text-lg font-semibold py-2 m-3">Town / City</label>
        <input
          className="border-2 border-stone-400 rounded-xl w-10/12 py-7 mt-1 m-3"
          type="text"
        />
        <label className="text-lg font-semibold py-2 m-3">Province</label>
        <select className="border-2 border-stone-400 bg-white rounded-xl w-10/12 text-lg text-muted py-7 px-5 mt-1 m-3">
        ...
        <label className="text-lg font-semibold py-2 m-3">ZIP code</label>
        <input
          className="border-2 border-stone-400 rounded-xl w-10/12 py-7 mt-1 m-3"
          type="number"
        />
        ...
        <input
          ...
          type="tel"
        />
        <label className="text-lg font-semibold py-2 m-3">Email address</label>
        <input
          className="border-2 border-stone-400 rounded-xl w-10/12 py-7 mt-1 m-3"
          type="email"
        />
